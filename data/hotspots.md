...
更新时间：2026-02-21T11:42:16.191895+08:00  
总条数：186  
...
## 4. New Anthropic research: Measuring AI agent autonomy in practice.
...
## 5. RT by @GoogleDeepMind: Not all the action happens on the mountain. There’s a lot that happens after every run. 
...
- 链接：https://nitter.net/i/status/2024201066640785837#m

## 6. Introducing EVMbench—a new benchmark that measures how well AI agents can detect, exploit, and patch high-severity smart contract vulnerabilities. https://openai.com/index/introducing-evmbench/
...
## 7. Crystal-clear audio. Granular control. Lyria 3 is our most capable music model yet. 🎶
...
## 8. RT by @nvidia: 🔒 We are heading to #S4x26 to help OT and ICS cybersecurity leaders put AI to work securing critical infrastructure. 
...
## 9. R to @GoogleDeepMind: Lyria 3 is rolling out today in beta in the @GeminiApp for everyone globally, making it easy to get started with custom audio. 🎛️
...
## 10. R to @GoogleDeepMind: We’re giving creators more control over what they produce, helping them steer:
🔵 Tempo settings
...
## 11. We just dropped Lyria 3: our latest generative music model. 🔊 
...
## 12. We’re partnering with government bodies and local institutions across India to accelerate discoveries in science and education. 🇮🇳
...
## 13. RT by @nvidia: At #IndiaAIImpactSummit2026, we revealed how agentic #AI is reshaping India's tech landscape.
...
## 14. India is entering a new age of industrialization. 👏
...
## 15. We're committing to cover electricity price increases from our data centers.
...
## 16. Pinned: Since xAI was formed just 30 months ago, the small and talented team has made remarkable progress.
...
## 18. From how the team operates, I always thought Codex would eventually win. But I am pleasantly surprised to see it happening so quickly.
...
## 19. We updated GPT-5.2 (the instant model) in ChatGPT today. Not a huge change, but hopefully you find it a little better.
...
## 20. When we released Claude Opus 4.5, we knew future models would be close to our AI Safety Level 4 threshold for autonomous AI R&D. We therefore committed to writing sabotage risk reports for future frontier models.
...
## 21. R to @AnthropicAI: Rather than making difficult calls about blurry thresholds, we decided to preemptively meet the higher ASL-4 safety bar by developing the report, which assesses Opus 4.6’s AI R&D risks in greater detail.
...
## 22. RT by @nvidia: .@Meta is deploying AI at scale through deep codesign across the full NVIDIA platform.
...
## 23. RT by @sama: It's been a huge month for Codex. 
...
## 26. Extremely grateful to work with Josh. No one could ask for a more committed, more thoughtful, or harder-working investor.
...
## 27. RT by @AnthropicAI: This is Claude Sonnet 4.6: our most capable Sonnet model yet.
...
## 28. We've signed an MOU with the Government of Rwanda—the first partnership of its kind in Africa—to bring AI to health, education, and other public sectors.
...
## 29. R to @OpenAI: Now in deep research you can:
...
## 31. R to @OpenAI: Listen to the OpenAI Podcast on—
Spotify
...
## 32. This week's podcast is all about ads.
...
## 40. R to @GoogleDeepMind: Gemini 3.1 Pro is rolling out now in the @GeminiApp and in @GoogleAIStudio for developers.
...
- 图片：![](https://nitter.net/pic/card_img%2F2024516429949628417%2FM2IFL-_D%3Fformat%3Djpg%26name%3D800x419)
