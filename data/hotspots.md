...
更新时间：2026-02-21T01:13:12.250892+08:00  
总条数：196  
...
## 4. R to @AnthropicAI: A central lesson of this work is that autonomy is co-constructed by the model, user, and product. It can't be fully characterized by pre-deployment evaluations alone.
...
## 5. R to @AnthropicAI: Software engineering makes up ~50% of agentic tool calls on our API, but we see emerging use in other industries. 
...
## 6. R to @AnthropicAI: Most agent actions on our API are low risk. 73% of tool calls appear to have a human in the loop, and only 0.8% are irreversible.
...
## 7. R to @AnthropicAI: Claude Code also encourages oversight by stopping to ask questions.
...
## 8. R to @AnthropicAI: But interruptions also increase with experience. New users interrupt Claude Code in 5% of turns, compared to 9% for more experienced users.
...
## 9. R to @AnthropicAI: As users gain experience, their oversight strategy shifts.
...
## 10. R to @AnthropicAI: Most Claude Code turns are short (median ~45 seconds). But the longest turns show where autonomy is heading.
...
## 11. R to @AnthropicAI: Agents are already being deployed across contexts that range from e-mail triage to cybersecurity research. 
...
## 12. New Anthropic research: Measuring AI agent autonomy in practice.
...
## 13. RT by @GoogleDeepMind: Not all the action happens on the mountain. There’s a lot that happens after every run. 
...
## 14. Introducing EVMbench—a new benchmark that measures how well AI agents can detect, exploit, and patch high-severity smart contract vulnerabilities. https://openai.com/index/introducing-evmbench/
...
## 15. Crystal-clear audio. Granular control. Lyria 3 is our most capable music model yet. 🎶
...
## 16. RT by @nvidia: 🔒 We are heading to #S4x26 to help OT and ICS cybersecurity leaders put AI to work securing critical infrastructure. 
...
## 17. R to @GoogleDeepMind: Lyria 3 is rolling out today in beta in the @GeminiApp for everyone globally, making it easy to get started with custom audio. 🎛️
...
## 18. R to @GoogleDeepMind: We’re giving creators more control over what they produce, helping them steer:
🔵 Tempo settings
...
## 19. R to @GoogleDeepMind: Here’s how we’re taking Lyria to the next level:
...
## 20. We just dropped Lyria 3: our latest generative music model. 🔊 
...
## 21. We’re partnering with government bodies and local institutions across India to accelerate discoveries in science and education. 🇮🇳
...
## 22. RT by @nvidia: At #IndiaAIImpactSummit2026, we revealed how agentic #AI is reshaping India's tech landscape.
...
## 23. India is entering a new age of industrialization. 👏
...
## 24. We're committing to cover electricity price increases from our data centers.
...
## 25. Pinned: Since xAI was formed just 30 months ago, the small and talented team has made remarkable progress.
...
## 27. From how the team operates, I always thought Codex would eventually win. But I am pleasantly surprised to see it happening so quickly.
...
## 28. We updated GPT-5.2 (the instant model) in ChatGPT today. Not a huge change, but hopefully you find it a little better.
...
## 29. R to @AnthropicAI: Rather than making difficult calls about blurry thresholds, we decided to preemptively meet the higher ASL-4 safety bar by developing the report, which assesses Opus 4.6’s AI R&D risks in greater detail.
...
## 30. When we released Claude Opus 4.5, we knew future models would be close to our AI Safety Level 4 threshold for autonomous AI R&D. We therefore committed to writing sabotage risk reports for future frontier models.
...
## 31. RT by @nvidia: .@Meta is deploying AI at scale through deep codesign across the full NVIDIA platform.
...
## 32. RT by @sama: It's been a huge month for Codex. 
...
## 35. Extremely grateful to work with Josh. No one could ask for a more committed, more thoughtful, or harder-working investor.
...
## 36. RT by @AnthropicAI: This is Claude Sonnet 4.6: our most capable Sonnet model yet.
...
## 37. We've signed an MOU with the Government of Rwanda—the first partnership of its kind in Africa—to bring AI to health, education, and other public sectors.
...
## 38. R to @OpenAI: Now in deep research you can:
...
## 39. Deep research in ChatGPT is now powered by GPT-5.2.
...
## 40. R to @OpenAI: Listen to the OpenAI Podcast on—
Spotify
